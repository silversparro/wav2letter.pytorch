...
if __name__ == '__main__':
    ...
    for i, (data) in tqdm(enumerate(test_loader), total=len(test_loader)):
        ...
        avgTime.append(afterDecoderTime-beforeInferenceTime)
        print 'inferenceTime Total {}, only decodingTime {}, model outputTime {}'.format((afterDecoderTime-beforeInferenceTime),(afterDecoderTime-beforeDecoderTime),(afterInferenceTime-beforeInferenceTime))
